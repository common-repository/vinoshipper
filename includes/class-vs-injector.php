...
class Vs_Injector {
	 ...
	 * @since    0.1.0
	 * @access   protected
	 * @var      Vs_Injector_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'VS_INJECTOR_VERSION' ) ) {
			$this->version = VS_INJECTOR_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Vs_Injector_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Vs_Injector_Loader    Orchestrates the hooks of the plugin.
	 */
